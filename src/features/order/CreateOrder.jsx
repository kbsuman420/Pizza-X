      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="grow">
            ...
            {formErrors?.phone && <p className="mt-2 rounded-md bg-red-100 p-2 text-xs">{formErrors.phone}</p>}
          </div>
        </div>
        ...
        <div className="relative mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="grow">
            ...
            type="text" disabled={isLoadingAddress} defaultValue={address} name="address" required />
          </div>

          {addressStatus === 'error' && <p className="mt-2 rounded-md bg-red-100 p-2 text-xs">{errorAddress}</p>}

          {!position.latitude && !position.longitude &&
          <span className="absolute right-0.75 z-50 top-0.75 sm:right-1.25 md:top-1.25">
